...
public class GameManager2 : MonoBehaviour
{
    ...
    void CharSet(){ 
        //GameObject player1 = PlayerInput.Instantiate(Resources.Load<GameObject>("Assets/Resources/HighQualityCGs/Normal/" + chosenCharacter1 + "cg"), pairWithDevice: loadInputs1.playerOneInput);
        //GameObject player2 = PlayerInput.Instantiate(Resources.Load<GameObject>("Assets/Resources/HighQualityCGs/Normal/" + chosenCharacter2 + "cg"), controlScheme: loadInputs1.playerTwoInput.displayName, loadInputs1.playerTwoInput);
